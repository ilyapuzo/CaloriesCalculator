...
Приложение позволяет добавлять ингредиенты, рассчитывать общую калорийность блюда, калорийность на одну порцию, сохранять список ингредиентов в базе данных, менять тему на тёмную/светлую.
...
9. Возможность сменить тему на темную / светлую, сохраняя тему при перезапуске приложения.
...
8. С помощью сочетания клавиш "Ctrl+T" меняется тема приложения.
...
8. Смена темы с помощью сочетания клавиш - Тема меняется.
